...
latex_elements = {
    ...
    'preamble': r'''
        ...
        \fancyfoot[R]{\ifthenelse{\isodd{\value{page}}}{{\tiny EnOS 身份与权限管理} }{\href{https://www.envisioniot.com}{\tiny IOT}}}
...
latex_documents = [
    (master_doc, u'EnOSDocumentationCenter.tex', u'身份与权限管理',
     u'远景智能', 'book', 'true'),
]
...
texinfo_documents = [
    (master_doc, 'EnOSDocumentationCenter', 'EnOS Identity and Access Management',
     author, 'EnOSDocumentationCenter', 'Product documentation about EnOS Identity and Access Management.',
     'Miscellaneous'),
]
